...
const RAW_INITIAL_TOOLS: AiTool[] = [
  ...
  },
  {
    ...
    rating: 4.9,
    tags: ['محرك بحث', 'أبحاث موثقة', 'Deep Research', 'اقتباس مصادر', 'Pro Search', 'بدائل_ChatGPT', 'بديل_Google_Search'],
    isAlternative: true,
  ...
  // ==========================================
  // ⚡ منصة بدائل الذكاء الاصطناعي (Alternative AI Tools Hub)
  // ==========================================
  {
    id: 'deepseek-r1',
    ...
    descriptionAr: 'نموذج استدلال وتفكير عميق متطور، يضاهي أقوى النماذج المدفوعة في حل الرياضيات المعقدة، تحليل الخوارزميات، والبرمجة، ومتاح مجاناً للجميع بدون اشتراكات أو قيود.',
    ...
    websiteUrl: 'https://chat.deepseek.com',
    rating: 4.9,
    tags: ['بدائل_ChatGPT', 'استدلال_عميق', 'أكواد_وبرمجة', 'مفتوح_المصدر', 'مجاني'],
    isAlternative: true,
    alternativeTo: ['ChatGPT Plus', 'OpenAI o1', 'OpenAI o3-mini', 'Claude 3.5 Sonnet'],
    academicTags: ['#بدائل_ChatGPT', '#محاكاة_رياضية', '#أكواد_وبرمجة'],
    isPopular: true,
    isFeatured: true,
    isNew: true,
    supportsArabic: true,
  ...
  {
    id: 'claude-3-7',
    nameAr: 'كلود 3.7 سونيت (النموذج الهجين الأقوى)',
    ...
    descriptionAr: 'أحدث إطلاق من شركة Anthropic، يتيح للمستخدم التبديل بين الرد الفوري السريع أو تشغيل التفكير العميق الممتد، وهو المعيار القياسي الحالي لمهندسي البرمجيات والباحثين في دقة النتائج وسلامة المنطق.',
    category: 'ai_alternatives',
    pricing: 'freemium',
    pricingAr: 'مجاني جزئياً (Freemium)',
    ...
    websiteUrl: 'https://claude.ai',
    rating: 5.0,
    tags: ['بدائل_ChatGPT', 'برمجة_فائقة', 'تفكير_عميق_Hybrid', 'تحليل_مستندات'],
    isAlternative: true,
    alternativeTo: ['ChatGPT Pro', 'GPT-4.5', 'Gemini Ultra'],
    academicTags: ['#بدائل_ChatGPT', '#كتابة_أكاديمية_LaTeX', '#تلخيص_الأوراق_العلمية'],
    isPopular: true,
    isFeatured: true,
    isNew: true,
    supportsArabic: true,
  ...
  },
  {
    ...
    descriptionAr: 'الجيل الأحدث من نماذج Google للذكاء الاصطناعي، يتميز بقدرته على تحليل ساعات من الفيديو وكتب كاملة دفعة واحدة، مع ربط حي بمحرك بحث Google وGoogle Workspace لتوليد إجابات حية وموثوقة.',
    category: 'ai_alternatives',
    pricing: 'freemium',
    pricingAr: 'مجاني جزئياً (Freemium)',
    ...
    websiteUrl: 'https://gemini.google.com',
    rating: 4.8,
    tags: ['بدائل_ChatGPT', 'Google', '2M_Context', 'تحليل_فيديو_يوتيوب'],
    isAlternative: true,
    alternativeTo: ['ChatGPT', 'Copilot', 'Claude Pro'],
    academicTags: ['#بدائل_ChatGPT', '#تلخيص_الأوراق_العلمية'],
    isPopular: true,
    isFeatured: true,
    isNew: true,
    supportsArabic: true,
  ...
  },
  {
    ...
    nameEn: 'Cursor AI',
    taglineAr: 'محرر الأكواد الذكي الرائد عالمياً القادر على فهم وتعديل مشاريعك البرمجية بالكامل',
  ...
  },
  {
    ...
    rating: 4.8,
    tags: ['بدائل_ChatGPT', 'أوروبي_مستقل', 'سريع_جداً', 'توليد_صور_Flux'],
    isAlternative: true,
    alternativeTo: ['ChatGPT', 'Claude Free', 'Microsoft Copilot'],
    academicTags: ['#بدائل_ChatGPT'],
    isPopular: true,
    supportsArabic: true,
    platforms: ['ويب', 'iOS', 'Android'],
    pros: [
  ...
  },
  {
    ...
    rating: 4.8,
    tags: ['Grok 3', 'xAI', 'بيانات_حيه_X', 'DeepSearch', 'أخبار_عاجلة', 'بدائل_ChatGPT'],
    isAlternative: true,
